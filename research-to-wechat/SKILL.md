...
Use the current alias map in [capability-map.md](~/Dropbox/My%20Apps/my-skills/research-to-wechat/references/capability-map.md).
...
Use the full style system in [style-engine.md](~/Dropbox/My%20Apps/my-skills/research-to-wechat/references/style-engine.md).
...
Use the execution contract in [execution-contract.md](~/Dropbox/My%20Apps/my-skills/research-to-wechat/references/execution-contract.md).
